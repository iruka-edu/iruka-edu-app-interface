...
export default function ProgressTrack({ value, ariaLabel = 'Lesson progress' }: ProgressTrackProps) {
  ...
  return (
    <div className="h-4 w-full rounded-full bg-[#2a3a43]" role="progressbar" aria-label={ariaLabel} aria-valuemin={0} aria-valuemax={100} aria-valuenow={Math.round(clamped * 100)}>
