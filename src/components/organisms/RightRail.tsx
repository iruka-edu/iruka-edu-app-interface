    ...
    <div className="flex h-full flex-col gap-5">
      ...
      <div className="mt-auto space-y-3 border-t border-[#24333d] pt-4">
        <div className="grid grid-cols-3 gap-2 text-xs font-medium tracking-wide text-[#7f95a1] uppercase">
          <Link href="/about" className="transition-colors hover:text-[#1cb0f6]">
            Giới thiệu
          </Link>
          <Link href="/store" className="transition-colors hover:text-[#1cb0f6]">
            Cửa hàng
          </Link>
          <Link href="/efficiency" className="transition-colors hover:text-[#1cb0f6]">
            Tính hiệu quả
          </Link>
        </div>
        <div className="grid grid-cols-3 gap-2 text-xs font-medium tracking-wide text-[#7f95a1] uppercase">
          <Link href="/careers" className="transition-colors hover:text-[#1cb0f6]">
            Công việc
          </Link>
          <Link href="/investors" className="transition-colors hover:text-[#1cb0f6]">
            Nhà đầu tư
          </Link>
          <Link href="/terms" className="transition-colors hover:text-[#1cb0f6]">
            Điều khoản
          </Link>
        </div>
        <div className="flex justify-center">
          <Link
            href="/privacy"
            className="text-xs font-medium tracking-wide text-[#7f95a1] uppercase transition-colors hover:text-[#1cb0f6]"
          >
            Quyền riêng tư
          </Link>
        </div>
